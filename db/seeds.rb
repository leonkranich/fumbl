...
user3 = User.create(email: email3, password: password3, password_confirmation: password_confirmation3, first_name: first_name3, last_name: last_name3, address: address3, teacher: teacher3)
